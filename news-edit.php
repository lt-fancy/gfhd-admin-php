...
<div class="page-container">
    <form method="post" class="form form-horizontal" id="form-article-add">
        <?PHP
            ...
            $isHome=$sql_arr['is_home'];
            $image=$sql_arr['image_uri'];
            $content=$sql_arr['list_content'];
        ?>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select id="is_home" name="" class="select">
...
<script type="text/javascript">
    ...
    var isHome = <?php echo $isHome==null?1:$isHome; ?>;
...
//        fileSingleSizeLimit:409600
    ...
    function save() {
        ...
        $.ajax({
            type: "POST",
            url: "base/newsSave.php",
            dataType: "json",
            data: {"id": id, "title": title,"is_home":isHome,"image":image,"content":um.getContent()},
